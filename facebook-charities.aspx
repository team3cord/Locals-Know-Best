...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <form id="mainForm" runat="server">
	       		...
	       		<p class="sub-head">Our merger with Washington Federal will bring over $250 million in community development funding during the next five years to Oregon and over $100,000 in direct contributions to our local charities in 2013 alone. We are also offering new grants to select Oregon charities of up to $5,000, and we would like you to tell us who you think deserves our support. Click on the charity logo or “Like” your choice from the list below, and you’ll be taken to Facebook where you can select Like, and we’ll make a $5 donation or grant to that organization. Be sure to let your friends know how they can benefit their favorite charitable organization by voting too.</p>
		...
		<div class="charities-tout">
			...
			<div class="charities-wrapper no-top-padding">
				...
				<!-- Pop up content -->
				<div id="neighbor-impact" class="pop-up" style="display:none;width:600px;">
	...
	<div class="charities-wrapper">
		...
		<!-- Pop up content -->
	    <div id="opp-knocks" class="pop-up" style="display:none;width:600px;">
...
<!-- END First C. -->
		...
		<div class="charities-tout">
			...
			<div class="charities-wrapper no-top-padding">
				...
				<!-- Pop up content -->
				<div id="iys" class="pop-up" style="display:none;width:600px;">
	...
	<div class="charities-wrapper">
		...
		<!-- Pop up content -->
	    <div id="jr-achievement" class="pop-up" style="display:none;width:600px;">
...
<!-- END Second C. -->
	    		...
	    		<div class="charities-tout no-margin-right">
                    ...
                    <span class="moneyRaised">$<em><%= GetMoney(VoteButton5.Charity) %></em> + raised</span>
	    				...
	    				<!-- Pop up content -->
	    				<div id="bngc" class="pop-up" style="display:none;width:600px;">
	    	...
	    	<div class="charities-wrapper">
	    		...
	    		<!-- Pop up content -->
	    	    <div id="goodwill" class="pop-up" style="display:none;width:600px;">
